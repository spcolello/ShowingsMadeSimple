...
export async function POST(request: Request) {
  ...
  if (!authenticatedAgentId || (payload.agentId && payload.agentId !== authenticatedAgentId)) {
  ...
  if (supabase) {
    ...
    await supabase.from("agent_availability").delete().eq("agent_id", authenticatedAgentId);
